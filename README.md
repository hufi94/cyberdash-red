...
downward. Because car and glow are one texture, they share the same frame,
scaling, position, fade and rotation with no second Kivy layer that can drift
away. The original no-red frames remain preserved separately.
...
and lets only a strong soft reflection spread downward. Every original Civic
